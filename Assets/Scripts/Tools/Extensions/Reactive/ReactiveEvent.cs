...
{
  internal class ReactiveEvent : IReadOnlyReactiveEvent, IDisposable
  {
  ...
  internal class ReactiveEvent<T> : IReadOnlyReactiveEvent<T>, IDisposable
  {
  ...
  internal class ReactiveEvent<T1, T2> : IReadOnlyReactiveEvent<T1, T2>, IDisposable
  {
